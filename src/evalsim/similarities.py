...
class Similarity(BaseModel):
    lexical: PooledResults | float| None = None
    semantic: PooledResults | float| None = None
    logical: PooledResults | float | None = None
    functional: PooledResults | float | None = None
