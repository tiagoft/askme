...
def load_dataset_sample(
        ...
        seed: int = 42,
        dataset_name: str = 'fancyzhx/ag_news') -> Tuple[List[str], List[int]]:
    """
    ...
    dataset = load_dataset(dataset_name, split='train', cache_dir='/mnt/data2/tiago/.cache/huggingface/datasets')
